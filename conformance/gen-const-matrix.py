...
materialization (the constant-materialization class, subject to the
named-constant invariant).
...
def print_lanes(type_key, var):
    ...
    for i in range(nlanes):
        ...
        out.append(f"testing.Println(cast(int, {e}))")
    return out
...
// as 16-bit little-endian lanes (target-stable). See ../../README.md.
