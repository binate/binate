...
*values*). Currently the **unary** sub-grid; the compound-assign × lvalue-form
sweep, the aggregate `==`/`!=` `.error` cells, and the pairwise binary sample are
planned follow-ups (§3.3).
